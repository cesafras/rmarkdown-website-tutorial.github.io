---
title: "Get You A Katie: An Analysis of Debut Novel Acknowledgements"
...
df_most_thanked_entities %>%
  ...
  ggtitle("Most acknowledged entities overall")
```

``` {r most_thanked_agencies, echo = FALSE}
...
df_most_thanked_agencies %>%
  ...
  theme(legend.position = "none",
        ...
        panel.border = element_blank(),
        axis.line = element_blank()) +
  ggtitle("Most acknowledged agencies")
```

``` {r most_thanked_individuals, echo = FALSE}
...
df_most_thanked_persons %>%
  ...
  theme(legend.position = "none",
        ...
        panel.border = element_blank(),
        axis.line = element_blank()) +
  ggtitle("Most acknowledged individuals")
```
...
ggplot(df_total_thanked, aes(x=total_thanked)) + 
  ...
  ggtitle("Distribution of number of entities acknowledged")
```
