...
* What MFAs/workshops/residencies should I apply to?
...
*On a related note, now feels like a good time to mention that this analysis was
heavily inspired by Richard Jean Ho's work on race in publishing. I've always
dreamed of the day that someone would successfully "Moneyball literature" and while
that's not exactly what he's doing, I really admire the use of data and analytics
to understand books and book publishing. Although my analysis does not directly
deal with race, some of my conclusions are related. Namely that the social
networks that award nominated writers navigate are quite compact (more on that
below) and—related to the Katie point—succeeding in the literary fiction game
requires the support of white people and institutions. (80% of people named Katie
are white, and 80% of agents and editors are white.)*
...
Alexander Chee. Seriously, from where I sit, he seems like the Tom Cruise (Harry
Styles? I don't celebrities) of the literary community. He's a BIG DEAL. So are
certain artists' colonies, like MacDowell and Yaddo, which you can read about,
but are basically cabin in the woods type situations where only the best, most
talented writers are invited to stay and take their lunch in hand-delivered
picnic baskets.
...
> One last thing: the hot mess fallacy
