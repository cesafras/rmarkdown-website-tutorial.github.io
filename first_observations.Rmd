...
`r colorize("The graphic above is a social network constructed of the  people (and organizations) mentioned in the acknowledgements sections of 80 novels longlisted for the Center for Fiction First Novel Prize.", "red")`
...
acknowledgements. So the biggest bubble (Bread Loaf) represents the node in the
...
by literary Twitter?
* And speaking of literary Twitter, is Alexander Chee the most beloved individual
...
Books, Amazon, and Axis360, the digital library.)
...
between Lucy Tan and Susie Yang hosted by everyone's favorite Brooklyn bookstore
Books Are Magic in which they revealed a long-standing friendship, so the fact
